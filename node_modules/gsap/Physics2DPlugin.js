    ...
    var p = Math.PI / 180,
        ...
        S = _gsScope._gsDefine.plugin({
            ...
            init: function(t, i, e, r) {
                ...
                for (var o, n = e._timeline, s = Number(i.angle) || 0, a = Number(i.velocity) || 0, h = Number(i.acceleration) || 0, f = i.xProp || "x", c = i.yProp || "y", _ = i.accelerationAngle || 0 === i.accelerationAngle ? Number(i.accelerationAngle) : s; n._timeline;) n = n._timeline;
            ...
            set: function(t) {
                var i, e, r, o, n, s, a = this._tween._time,
                    h = this._x,
                    f = this._y;
                if (!0 === this._runBackwards && (a = this._tween._duration - a), 1 === this._friction) r = a * a * .5, i = h.start + (h.velocity * a + h.acceleration * r), e = f.start + (f.velocity * a + f.acceleration * r);
                else {
