...
const ProductPrev = props => {
    ...
    return (
        <div className="product-prev">
            <div className="product-prev__img" style={style}></div>
            <div className="product-prev__header">
                <h3 className="product-prev__title">{props.title}</h3>
                <a className="product-prev__category">{props.category}</a>
            </div>
            <div className="product-prev__footer">
                <span className="product-prev__price">{props.price}</span>
