            ...
            <div className="login__body">
                ...
                <div className="login__box">
                    <form className="login__form">
                        ...
                        <input className="input input--secondary mg-bottom-md" type="email"/>
                        <label className="label label--secondary">رمز عبور</label>
                        <input className="input input--secondary mg-bottom-lg" type="password"/>
                        <button className="btn btn--fat btn--primary mg-bottom-md" type="submit">ورود</button>
