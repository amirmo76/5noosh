...
export default class ProductPrev extends React.Component {
  ...
  render() {
    const style = {
      backgroundImage: `url(${this.props.product &&
    ...
    return (
      <div
        className={
          "product-prev" +
          (this.props.slideshow ? " product-prev--slide-show" : "") +
          (this.props.slideshow
            ? " product-prev--slide-show-" + this.props.slideshow
            : "")
        }
        onClick={this.props.onClick}
        slideshow-position={this.props.slideshow}
      >
        {this.props.product && this.props.product.off && (
          <svg
            className="product-prev__off"
            height="512pt"
            viewBox="0 0 512 512"
            width="512pt"
          ...
          >
            ...
            />
            <path
              d="m344.769531 167.230469c-5.765625-5.765625-15.121093-5.765625-20.886719 0l-67.882812 67.882812v41.773438l88.769531-88.769531c5.765625-5.765626 5.765625-15.117188 0-20.886719zm0 0"
              fill="#fbc02d"
            />
            <path
              d="m195.078125 237.539062c23.410156 0 42.460937-19.050781 42.460937-42.460937 0-23.414063-19.050781-42.460937-42.460937-42.460937-23.414063 0-42.460937 19.046874-42.460937 42.460937 0 23.410156 19.046874 42.460937 42.460937 42.460937zm0 0"
              fill="#fdd835"
            />
            <path
              d="m316.921875 274.460938c-23.410156 0-42.460937 19.050781-42.460937 42.460937 0 23.414063 19.050781 42.460937 42.460937 42.460937 23.414063 0 42.460937-19.046874 42.460937-42.460937 0-23.410156-19.046874-42.460937-42.460937-42.460937zm0 0"
              fill="#fbc02d"
            />
          </svg>
        )}
        <div className="product-prev__img" style={style}>
          <div className="product-prev__more">
            <p className="product-prev__more-text">
              {this.props.product && this.props.product.shortDesc}
            </p>
            <Link
              to={
                "/product" + "/" + (this.props.product && this.props.product.id)
              }
            >
              <button className="btn btn--primary btn--no-up-animation btn--shadow-animation">
                توضیحات بیشتر
              </button>
            </Link>
          </div>
        ...
        <div className="product-prev__header">
          <h3 className="product-prev__title">
            {this.props.product && this.props.product.title}
          </h3>
          <a className="product-prev__category">
        ...
        <div className="product-prev__footer">
...

          {
            ...
            >
              <svg
                className={
                  "product-prev__svg product-prev__svg--back" +
                  (this.props.homeSales ? " no-margin" : "")
                }
                id="Capa_1"
                xmlns="http://www.w3.org/2000/svg"
                width="459"
          ...
          {this.props.homeSales || (
            <svg
              className="product-prev__svg product-prev__svg--add"
              xmlns="http://www.w3.org/2000/svg"
