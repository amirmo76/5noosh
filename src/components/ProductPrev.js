        ...
        return (
            <div className={"product-prev" + (this.props.slideshow ? " product-prev--slide-show" : "") + (this.props.slideshow ? (" product-prev--slide-show-" + this.props.slideshow) : "")} onClick={this.props.onClick} slideshow-position={this.props.slideshow}>
                ...
                <div className="product-prev__footer">
                    <span className={"product-prev__price " + ((this.props.product && this.props.product.off) ? "product-prev__price--off" : "")}>{(this.props.product && this.props.product.off) ? this.stylizePrice(this.calculatePrice(this.props.product.price, this.props.product.off)) : this.stylizePrice(this.props.product.price)}</span>
