...
export default class extends React.Component {
    ...
    initAnimation = e => {
        ...
        anim
            .from(selector, 1, {y: "200px", opacity: 0, ease: Power2.easeOut});
        ...
        return (
            <div className="features">
                <div className="features__component">
                    <svg className="features__svg" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 437.6 437.6'>
                ...
                <div className="features__component">
                    <svg className="features__svg" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 495.622 495.622'>
                ...
                <div className="features__component">
                    <svg className="features__svg" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
