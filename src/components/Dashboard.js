...
export default class Dashboard extends React.Component {
  ...
  changePassClickHandler = e => {
    ...
    if (
      ...
      this.state.newPassConfirmValid
    ) {
      //gatehring values
      const prevPass = document.getElementById("prev-pass").value;
      const newPass = document.getElementById("new-pass").value;
      const newPassConfirm = document.getElementById("new-pass-confirmation")
        .value;
  ...
  inputOnChangeHandle = e => {
    ...
    if (e.target.classList.contains("dashboard__info-input--name")) {
      ...
      e.target.classList.contains(
        "dashboard__info-input--new-pass-confirmation"
      )
    ) {
      let result =
        document.getElementById("new-pass-confirmation").value ===
        document.getElementById("new-pass").value;
      this.setState(() => ({
        newPassConfirmTouched: true,
        newPassConfirmValid: result
      }));
    }
  };
  ...
  changePassJSX = (
    <form className="dashboard__change-pass-form">
      <label htmlFor="prev-pass" className="label">
        رمز عبور فعلی
      </label>
      <input
        type="password"
        className="input input--tertiary dashboard__info-input--pass mg-bottom-md"
        id="prev-pass"
        required
      ...
      <input
        type="password"
        className="input input--tertiary dashboard__info-input--new-pass mg-bottom-md"
        id="new-pass"
        required
        onChange={this.inputOnChangeHandle}
      />
      <label htmlFor="new-pass-confirmation" className="label">
        تکرار رمز عبور جدید
      </label>
      <input
        type="password"
        className="input input--tertiary dashboard__info-input--new-pass-confirmation mg-bottom-md"
      ...
      <button
        type="submit"
        class="btn btn--tall btn--no-up-animation btn--outline-dark"
        onClick={this.changePassClickHandler}
      >
        ثبت
      </button>
    </form>
  ...
  activePurchaceTitleMaker(titles) {
    if (titles) {
      ...
      if (titles.length > 2) {
        ...
        titles.forEach(cur =>
          res.length > 2 ? (res = res + cur) : (res = cur + " و ")
        );
      }
      return res;
    }
    ...
    return (
      <>
        ...
        <div className="dashboard">
          ...
          />
          <div className="news">
            <p className="news__title">:آخرین اطلاعیه های سایت</p>
            ...
            <div className="dashboard__container">
              <div className="dashboard__card dashboard__card--info">
                ...
                <div
                  ...
                  className="dashboard__edit-box"
                >
                  {!this.state.editMode ? (
                    <svg
                      className="dashboard__edit-icon"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 25 24.878"
                    >
                      <defs />
                      <path
                        id="Path_1342"
                        data-name="Path 1342"
                        d="M15.546,5.441l5.086,5.086L7.759,23.4,2.676,18.314Zm8.945-1.227L22.223,1.946a2.251,2.251,0,0,0-3.179,0L16.871,4.119,21.957,9.2,24.491,6.67A1.734,1.734,0,0,0,24.491,4.214ZM.015,25.462a.579.579,0,0,0,.7.688l5.667-1.374L1.3,19.691Z"
                    ...
                    <svg
                      className="dashboard__edit-icon"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 89.331 64.278"
                    >
                      <defs />
                      <path
                        id="checked_1_"
                        className="cls-1"
                        d="M32.139,124.109a7.061,7.061,0,0,1-5.01-2.075L2.076,96.98A7.086,7.086,0,0,1,12.1,86.959L32.139,107l45.1-45.1a7.086,7.086,0,1,1,10.02,10.021L37.15,122.034A7.067,7.067,0,0,1,32.139,124.109Z"
                  ...
                  {!this.state.editMode ? (
                    ...
                    <p
                      className="dashboard__edit-text"
                      onClick={this.submitInfoFormHandler}
                    >
                      ثبت تغییرات
                    </p>
                  )}
                ...
                <form className="dashboard__avatar-form" id="avatar-form">
                  <label
                    className={
                      "dashboard__avatar" +
                      (this.state.editMode
                        ? " dashboard__avatar--editable"
                        : "")
                    }
                    style={style}
                    htmlFor={this.state.editMode ? "avatar" : ""}
                  >
                    <svg
                      className="dashboard__avatar-icon"
                      id="Capa_1"
                      xmlns="http://www.w3.org/2000/svg"
                      width="475.078"
                      height="475.077"
                ...
                <label className="dashboard__label dashboard__label--right">
                  نام و نام خانوادگی
                </label>

                {!this.state.editMode ? (
                  <p className="dashboard__info dashboard__info--name">
                  ...
                  <input
                    ...
                    className="dashboard__info-input dashboard__info-input--name"
                    onChange={this.inputOnChangeHandle}
                  />
                )}
                ...
                {!this.state.editMode ? (
                  <p className="dashboard__info dashboard__info--email">
                  ...
                  <input
                    ...
                    className="dashboard__info-input dashboard__info-input--email"
                    onChange={this.inputOnChangeHandle}
                  />
                )}

                <label className="dashboard__label dashboard__label--left dashboard__label--state">
                  استان
                </label>

                {!this.state.editMode ? (
                  <p className="dashboard__info dashboard__info--state">
                  ...
                  <input
                    ...
                    className="dashboard__info-input dashboard__info-input--state"
                    onChange={this.inputOnChangeHandle}
                  />
                )}
                ...
                {!this.state.editMode ? (
                  <p className="dashboard__info dashboard__info--phone">
                  ...
                  <input
                    ...
                    className="dashboard__info-input dashboard__info-input--phone"
                    onChange={this.inputOnChangeHandle}
                  />
                )}

                <label className="dashboard__label dashboard__label--left dashboard__label--city">
                  شهر
                </label>

                {!this.state.editMode ? (
                  <p className="dashboard__info dashboard__info--city">
                  ...
                  <input
                    ...
                    className="dashboard__info-input dashboard__info-input--city"
                    onChange={this.inputOnChangeHandle}
                  />
                )}
                ...
                {!this.state.editMode ? (
                  <p className="dashboard__info dashboard__info--zip-code">
                  ...
                  <input
                    ...
                    className="dashboard__info-input dashboard__info-input--zip-code"
                    onChange={this.inputOnChangeHandle}
                  />
                )}
                ...
                {!this.state.editMode ? (
                  <p className="dashboard__info dashboard__info--address">
                  ...
                  <input
                    ...
                    className="dashboard__info-input dashboard__info-input--address"
                    onChange={this.inputOnChangeHandle}
                  />
                )}
                ...
                <div className="dashboard__pass-box" id="change-pass">
                  <svg
                    className="dashboard__pass-icon"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                  >
                    <defs />
              ...
              <div className="dashboard__card dashboard__card--notifs">
                <h2 className="dashboard__card-title dashboard__card-title--light mg-bottom-md">
                  آخرین اعلان های شما
                </h2>
                <div className="dashboard__notifs-container">
                  {this.state.notifications.length === 0 && (
                    <p className="dashboard__empety">
                      موردی برای نمایش وجود ندارد
                    </p>
                  )}
                </div>
                <Link to="/dashboard/notifications" className="margin-top-auto">
                  <button className="btn btn--stretch-x btn--no-up-animation btn--outline">
                    مشاهده همه
                  </button>
                </Link>
              </div>
              ...
              <div className="dashboard__card dashboard__card--history">
                <h2 className="dashboard__card-title mg-bottom-md">
                  سفارش های شما
                </h2>
                    ...
                    this.state.purchases.map((cur, i) => {
                      ...
                      return (
                        <div className="dashboard__order-container">
                          ...
                          <p className="dashboard__order-state">
                            {this.getStatus(cur.status)}
                          </p>
                        </div>
                      );
                    })
                ...
                <Link to="/dashboard/histories" className="margin-top-auto">
                  <button className="btn btn--stretch-x btn--no-up-animation btn--outline-dark">
                    مشاهده همه
                  </button>
                </Link>
              </div>
                  ...
                  <div className="dashboard__status-container">
                    <div
                      className={
                        ...
                        (cur.status >= 0
                          ? " dashboard__status-box--active"
                          : "")
                      }
                    >
                      <svg
                        className="dashboard__status-svg"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 146 146"
                      >
                        <defs />
                        <g
                          id="Group_306"
                          data-name="Group 306"
                          transform="translate(-1452 -1269)"
                        >
                          <circle
                            className="dashboard__status-circle"
                            id="Ellipse_163"
                      ...
                      <p className="dashboard__status-title">ثبت شده</p>
                    </div>
                    ...
                    >
                      <svg
                        className="dashboard__status-svg"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 170.824 170.907"
                      >
                        <defs />
                        <g
                          id="Group_307"
                          data-name="Group 307"
                          transform="translate(-1129.018 -1261.093)"
                        >
                          <path
                            className="dashboard__status-circle"
                            id="Path_1365"
                            data-name="Path 1365"
                            d="M73,0A73,73,0,1,1,0,73,73,73,0,0,1,73,0Z"
                            transform="translate(1148 1269)"
                          />
                          <g
                            id="execution"
                            transform="translate(1128.903 1261.094)"
                          >
                            <g
                              id="Group_248"
                              data-name="Group 248"
                            ...
                            <g
                              id="Group_250"
                              data-name="Group 250"
                              transform="translate(17.015 17.124)"
                            >
                              <g id="Group_249" data-name="Group 249">
                                <path
                                  id="Path_1344"
                                  data-name="Path 1344"
                                  d="M67.468,48.005A19.977,19.977,0,1,0,87.445,67.982,19.977,19.977,0,0,0,67.468,48.005Zm0,34.246A14.269,14.269,0,1,1,81.737,67.982,14.269,14.269,0,0,1,67.468,82.251Z"
                            ...
                            <g
                              id="Group_254"
                              data-name="Group 254"
                              transform="translate(125.461 17.124)"
                            >
                              <g id="Group_253" data-name="Group 253">
                                <path
                                  id="Path_1346"
                                  data-name="Path 1346"
                                  d="M365.76,48.005a14.269,14.269,0,1,0,14.269,14.269A14.269,14.269,0,0,0,365.76,48.005Zm0,22.831a8.562,8.562,0,1,1,8.562-8.562A8.561,8.561,0,0,1,365.76,70.836Z"
                            ...
                            <g
                              id="Group_258"
                              data-name="Group 258"
                              transform="translate(102.631 102.74)"
                            >
                              <g id="Group_257" data-name="Group 257">
                                <path
                                  id="Path_1348"
                                  data-name="Path 1348"
                                  d="M313.176,288.005A25.685,25.685,0,1,0,338.86,313.69,25.685,25.685,0,0,0,313.176,288.005Zm0,45.661a19.977,19.977,0,1,1,19.977-19.977A20,20,0,0,1,313.176,333.667Z"
                            ...
                            <g
                              id="Group_260"
                              data-name="Group 260"
                              transform="translate(79.8 31.394)"
                            >
                            ...
                            <g
                              id="Group_262"
                              data-name="Group 262"
                              transform="translate(14.162 77.055)"
                            >
                              <g id="Group_261" data-name="Group 261">
                                <path
                                  id="Path_1349"
                                  data-name="Path 1349"
                                  d="M104.9,263.4a2.852,2.852,0,0,0-1.5-1.5h0l-19.977-8.562a2.852,2.852,0,0,0-3.977,2.622v5.708H45.2V216H39.491v48.515a2.852,2.852,0,0,0,2.851,2.854h37.1v5.708a2.852,2.852,0,0,0,2.85,2.854h0a2.812,2.812,0,0,0,1.123-.231l19.977-8.562A2.852,2.852,0,0,0,104.9,263.4Zm-19.747,5.355v-8.467l9.877,4.233Z"
                            ...
                            <g
                              id="Group_264"
                              data-name="Group 264"
                              transform="translate(114.882 118.034)"
                            >
                              <g id="Group_263" data-name="Group 263">
                                <path
                                  id="Path_1350"
                                  data-name="Path 1350"
                                  d="M344.489,330.88,332.221,345.6l-6.352-6.351-4.035,4.035,8.562,8.562a2.845,2.845,0,0,0,2.018.836c.042,0,.086,0,.128,0a2.858,2.858,0,0,0,2.065-1.023l14.269-17.123Z"
                    ...
                    >
                        ...
                        >
                          ...
                          <g id="shipped" transform="translate(842 1217.279)">
                            ...
                            <g
                              id="Group_268"
                              data-name="Group 268"
                              transform="translate(72.318 142.53)"
                            >
                              <g id="Group_267" data-name="Group 267">
                                <path
                                  id="Path_1352"
                                  data-name="Path 1352"
                                  d="M131.684,350.6a3.142,3.142,0,1,1-3.418,3.13A3.287,3.287,0,0,1,131.684,350.6Z"
                            ...
                            <g
                              id="Group_270"
                              data-name="Group 270"
                              transform="translate(14.111 142.53)"
                            >
                              <g id="Group_269" data-name="Group 269">
                                <path
                                  id="Path_1353"
                                  data-name="Path 1353"
                                  d="M413.873,350.6a3.142,3.142,0,1,1-3.418,3.13A3.287,3.287,0,0,1,413.873,350.6Z"
                            ...
                            <g
                              id="Group_272"
                              data-name="Group 272"
                              transform="translate(35.277 136.068)"
                            >
                              <g id="Group_271" data-name="Group 271">
                                <path
                                  id="Path_1354"
                                  data-name="Path 1354"
                                  d="M206.881,316.393h24.694a1.521,1.521,0,1,1,0,3.029H206.881a1.521,1.521,0,1,1,0-3.029Z"
                            ...
                            <g
                              id="Group_274"
                              data-name="Group 274"
                              transform="translate(77.61 129.605)"
                            >
                              <g id="Group_273" data-name="Group 273">
                                <path
                                  id="Path_1355"
                                  data-name="Path 1355"
                                  d="M18.756,282.188H39.922a1.521,1.521,0,1,1,0,3.029H18.756a1.521,1.521,0,1,1,0-3.029Z"
                            ...
                            <g
                              id="Group_276"
                              data-name="Group 276"
                              transform="translate(49.278 108.602)"
                            >
                              <g id="Group_275" data-name="Group 275">
                                <path
                                  id="Path_1356"
                                  data-name="Path 1356"
                                  d="M169.637,171.466a1.42,1.42,0,0,0-2.062,0l-12.969,13.469-6.746-7.007a1.42,1.42,0,0,0-2.062,0,1.556,1.556,0,0,0,0,2.142l7.778,8.078a1.42,1.42,0,0,0,2.062,0l14-14.54A1.556,1.556,0,0,0,169.637,171.466Z"
                      ...
                      <p className="dashboard__status-title">ارسال محموله</p>
                    </div>
                        ...
                        >
                          ...
                          <g id="product" transform="translate(519.501 1288)">
                            <path
                              id="Path_1357"
                              data-name="Path 1357"
                              d="M124.961,60h38.257a3.157,3.157,0,0,1,3.188,3.188v38.47a3.158,3.158,0,0,1-3.188,3.188H124.961a3.157,3.157,0,0,1-3.188-3.188V63.188A3.157,3.157,0,0,1,124.961,60Zm0,0"
                              transform="translate(-96.676 -47.248)"
                            />
                            <path
                              id="Path_1358"
                              data-name="Path 1358"
                              d="M.867,245.654l14.665,27.991A22.313,22.313,0,0,0,35.3,285.633H62.015L74.13,297.705a3.425,3.425,0,0,0,2.232.893,3.463,3.463,0,0,0,2.3-.893l15.941-15.9a3.273,3.273,0,0,0,0-4.526L75.724,258.406a15.868,15.868,0,0,0-11.286-4.654H31.281a2.765,2.765,0,0,0-2.423,4.081c1.4,2.742,3.06,5.93,3.634,6.95A3.18,3.18,0,0,0,35.3,266.5h21.68a3.188,3.188,0,0,1,0,6.376H35.3s-6.758-1.977-8.416-5.1L17.063,249.1A15.147,15.147,0,0,0,3.672,241a3.13,3.13,0,0,0-2.678,1.53,3.055,3.055,0,0,0-.127,3.124Zm0,0"
                              transform="translate(0 -189.777)"
                            />
                            <path
                              id="Path_1363"
                              data-name="Path 1363"
                              d="M236.337,6.376V0a9.551,9.551,0,0,0-9.564,9.564V22.317a3.188,3.188,0,0,0,6.376,0V9.564A3.157,3.157,0,0,1,236.337,6.376Zm0,0"
                              transform="translate(-188.924)"
                            />
                            <path
                              id="Path_1364"
                              data-name="Path 1364"
                              d="M226.773,6.376V0c5.775,0,10.435,4.272,10.435,9.564V22.317a3.492,3.492,0,0,1-6.957,0V9.564A3.31,3.31,0,0,0,226.773,6.376Zm0,0"
                              transform="translate(-179.359)"
                            />
                          </g>
                        </g>
                      </svg>
                      <p className="dashboard__status-title">دریافت محموله</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          {this.state.path === this.HISTORY && (
            <div className="histories__container">
              <Histories
                ...
                titleMaker={this.activePurchaceTitleMaker}
              />
            </div>
          )}
